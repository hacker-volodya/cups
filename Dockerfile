...
RUN set -eux; \
    ...
    perl -0pe 's/\*PCFileName: "TDP-245 Plus\.ppd"/\*PCFileName: "TDP245TS.PPD"/; s/\*cupsVersion: 1\.2\n\*cupsManualCopies: False\n\*cupsFilter: "application\/vnd\.cups-raster 0 \/Library\/Printers\/TSC\/Filter\/rastertobarcodetspl"/\*cupsVersion: 1.5\n\*cupsModelNumber: 37155\n\*cupsManualCopies: False\n\*cupsFilter: "application\/vnd.cups-raster 100 raster-tspl"/; s/\*cupsLanguages: "en zh_CN zh_TW"/\*cupsLanguages: "en"/; s/\*DefaultPageRegion: w2h4/\*DefaultPageRegion: w2h4\n\*DefaultImageableArea: w2h4\n\*DefaultPaperDimension: w2h4/; s/\*DefaultMarkHeight: 3/\*DefaultMarkHeight: 8.50/; s/\bw2h4\b/2x4.Fullbleed/g; s/\bw4h4\b/4x4.Fullbleed/g; s/\bw4h6\b/4x6.Fullbleed/g' "TSC_MAC_driver/PPDs/TDP-245 Plus.ppd" > /usr/share/cups/model/tspl/TDP-245-Plus-tspl.ppd; \
    rm -rf "$tmpdir"
